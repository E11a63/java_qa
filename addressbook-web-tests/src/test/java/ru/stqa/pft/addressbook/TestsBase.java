...
public class TestsBase {
  ...
  protected void viewNewcreateContacts() {
    wd.findElement(By.linkText("home")).click();
  }

  protected void creationNewContacts() {
  ...
  protected void addNewContacts() {
    wd.findElement(By.linkText("add new")).click();
  }

  protected void serchForm() {
  ...
  protected void returneGroupPage() {
    wd.findElement(By.linkText("group page")).click();
  }
  ...
  protected void delitionContractElemtnt() {
      wd.findElement(By.xpath("//div[@id='content']/form[2]/div[2]/input")).click();
  }

  protected void selectContactElement() {
